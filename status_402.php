	...
	<body>
			...
			<header id="header">
				...
				<nav class="right">
					<?php
						...
						{
							//已經登入
							if ($_COOKIE['Ulogin']=="管理員"||$_COOKIE['Ulogin']=="管理員2"||$_COOKIE['Ulogin']=="class3")
		...
		<!-- Two -->
			<section id="two" class="wrapper  special">
				<div class="inner">
					<h2>考生目前狀態(402接待使用)</h2>
					<h3><font style="background:#FFD6A5">"橘格"</font>應該正在前往420</h3>
					<h3>引導至試場門口後請變更為<font style="background:#CAFFBF">"綠格"</font></h3>
					<hr>
					<h3>
					...
					<hr>
						<div class="12u">
							<div class="table-wrapper" style="color:black;">
								<form method="post" style="width:100%;" action="statuscheck_402.php">
										...
										<?php
											...
											while ($A_rowres = mysqli_fetch_array($A_result_status, MYSQLI_BOTH))
											{
												...
												<?php
													...
													{
												?>
														<td style="background-color:<?php echo $Color?>"><button name="<?php echo "C_".$A_rowres[0]?>" class="button special small" style="padding: 0 0.8em;">搞錯了</button></td>
												<?php
													}
													else
													{
